...
package com.vaadin.componentfactory.dropdown;

import com.vaadin.componentfactory.dropdown.event.ItemChangeEvent;
import com.vaadin.componentfactory.dropdown.event.SelectionEvent;
...
@JsModule("./src/views/dropdown/adadropdown.tsx")
@JsModule("./styles/css.ts")
@CssImport("./styles/components.css")
public class AdaDropDown extends Div {
    public AdaDropDown() {
        setId("visualization" + this.hashCode());
        setWidthFull();
        setClassName("adadropdown");
    }
