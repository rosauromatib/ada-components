...
package com.vaadin.componentfactory.accordion;
...
@JsModule("./src/views/accordion/adaaccordion.tsx")
@JsModule("./styles/css.ts")
@CssImport("./styles/components.css")
public class AdaAccordion extends Div {
    public AdaAccordion() {
        setId("visualization" + this.hashCode());
        setWidthFull();
        setClassName("adaaccordion");
    }

    /**
     * Method called when the component is attached to the UI.
     * It initializes the AdaAccordion component.
     */
    @Override
    ...
    private void initAdaAccordion() {
        this.getElement()
                .executeJs(
                        "adaaccordion.create($0, $1, $2);",
                        this, "[]" ,
