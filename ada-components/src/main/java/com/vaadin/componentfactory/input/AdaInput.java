...
package com.vaadin.componentfactory.input;
...
@JsModule("./src/views/input/adainput.tsx")
@JsModule("./styles/css.ts")
@CssImport("./styles/components.css")
public class AdaInput extends Div {
    ...
    private void initAdaInput() {
        this.getElement()
                .executeJs(
                        "adainput.create($0, $1, $2);",
                        this, "[]" ,
